...
- [x] 7. Private `ssotest` credentials use `E2E_STAFF_EMAIL`/`E2E_STAFF_PASSWORD` from ignored `.env`; account source metadata is under `~/leo/contentoren-server/zitadel`; full callback, logout, and relogin passed.
