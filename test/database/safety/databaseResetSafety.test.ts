...
const resetLockScript = await Bun.file(
  new URL("../../../scripts/managedDatabaseResetLockRun.ts", import.meta.url),
).text()
const consumersScript = await Bun.file(
  new URL("../../../scripts/managedDatabaseConsumersStop.ts", import.meta.url),
).text()
