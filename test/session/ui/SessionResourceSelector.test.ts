...
const selector = await Bun.file(new URL("../../../src/session/ui/SessionResourceSelector.tsx", import.meta.url)).text()
const inspector = await Bun.file(new URL("../../../src/session/ui/SkillCatalogInspector.tsx", import.meta.url)).text()
const capturedContext = await Bun.file(
  new URL("../../../src/session/ui/SessionCapturedContextInspector.tsx", import.meta.url),
).text()
