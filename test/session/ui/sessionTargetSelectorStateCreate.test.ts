...
import type { SessionProjectTarget } from "../../../src/session/ui/sessionProjectTarget.js"
...
test("workspace target controls hide server selection while retaining agent selection", async () => {
  const source = await Bun.file(new URL("../../../src/session/ui/SessionTargetSelector.tsx", import.meta.url)).text()
