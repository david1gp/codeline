...
const sidebarSource = await Bun.file(new URL("../../../src/session/ui/SessionSidebar.tsx", import.meta.url)).text()
const targetSelectorSource = await Bun.file(
  new URL("../../../src/session/ui/sessionTargetSelectorStateCreate.ts", import.meta.url),
).text()
