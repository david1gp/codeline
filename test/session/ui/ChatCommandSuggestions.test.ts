...
const suggestions = await Bun.file(
  new URL("../../../src/session/ui/ChatCommandSuggestions.tsx", import.meta.url),
).text()
const sessionChat = await Bun.file(new URL("../../../src/session/ui/SessionChat.tsx", import.meta.url)).text()
